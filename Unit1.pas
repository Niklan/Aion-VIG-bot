...
begin
 if patch1506.Checked=True then  //патч 1.5.0.6
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDC8;
  end;
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A27720;
  end;
 if patch1517.Checked=True then  //патч 1.5.1.7
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9B0;
  end;
 if patch1901.Checked=True then  //патч 1.9.0.1
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A82428;
  end;
...
begin
 if patch1506.Checked=True then  //патч 1.5.0.6
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDC4;
  end;
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDC4;
 ...
 if patch1517.Checked=True then  //патч 1.5.1.7
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9AC;
  end;
 if patch1901.Checked=True then  //патч 1.9.0.1
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A82424;
  end;
  HandleWindow :=FindWindow(nil, 'AION Client');
    if(HandleWindow  <> 0) then
      GetWindowThreadProcessId(HandleWindow  ,@ProcessId);
...
begin
 if patch1506.Checked=True then  //патч 1.5.0.6
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDD0;
  end;
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDD0;
 ...
 if patch1517.Checked=True then  //патч 1.5.1.7
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9B8;
  end;
 if patch1901.Checked=True then  //патч 1.9.0.1
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9B0;
...
begin
 if patch1506.Checked=True then  //патч 1.5.0.6
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$8EDDCC;
  end;
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A27724;
  end;
 if patch1517.Checked=True then  //патч 1.5.1.7
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9B4;
  end;
 if patch1901.Checked=True then  //патч 1.9.0.1
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$A2F9B0;
...
begin
 ...
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$62EB7C;
  end;
 if patch1517.Checked=True then  //патч 1.5.1.7
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$636BBC;
  end;
 if patch1901.Checked=True then  //патч 1.9.0.1
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$66FB78;
  end;
  HandleWindow :=FindWindow(nil, 'AION Client');
    if(HandleWindow  <> 0) then
      GetWindowThreadProcessId(HandleWindow  ,@ProcessId);
...
begin
 if patch1506.Checked=True then  //патч 1.5.0.6
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$4F5878;
  end;
 if patch1514.Checked=True then  //патч 1.5.1.4
  begin
    address:=GetModuleBase(ProcessId, 'Game.dll')+$62EB7C;
